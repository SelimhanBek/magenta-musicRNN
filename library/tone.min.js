!(function (n, t) {
  ...
  function r(n, t) {
    return (
      (n = Math.round(n)), (!0 === t ? G : I)[n % 12] + (Math.floor(n / 12) - 1)
    );
  }
  function e(n, t) {
    for (var r = []; t--; r[t] = t + n);
  ...
  function o(n) {
    return an(n.map(R)).sort(function (n, t) {
      return ln(n) > ln(t);
    });
  }
  function P(n) {
  ...
  function M(n) {
    return "string" != typeof n ? gn : zn[n] || (zn[n] = _n(n));
  }
  function a(n) {
    var t = (n + 1) % 7;
    return t < 0 ? 7 + t : t;
  ...
  function c(n, t) {
    ...
    var r = Qn(n);
    return null === r ? null : un(Hn(r[0] + t));
  }
  function s(n, t) {
    if (1 === arguments.length)
      return function (t) {
  ...
  function E(n, t) {
    var r = C(n);
    return (t = t || r[1]), _t(t).intervals.map(l(r[0]));
  }
  function C(n) {
    var r = t(n);
    return "" === r[0]
  ...
  var $ = "C C# Db D D# Eb E F F# Gb G G# Ab A A# Bb B".split(" "),
    ...
    sn = function (n) {
      return 0 === n.length
        ? [[]]
        : sn(n.slice(1)).reduce(function (t, r) {
            return t.concat(
              n.map(function (t, e) {
                var m = r.slice();
      ...
      return (
        ...
        "M" === r.type && "P" === r.q
          ...
          : ((r.name = "" + r.num + r.q),
            ...
            (r.semitones = r.dir * (pn[r.step] + r.alt + 12 * r.oct)),
            (r.chroma = (((r.dir * (pn[r.step] + r.alt)) % 12) + 12) % 12),
            Object.freeze(r))
      );
    },
    zn = {},
    ...
    $n = function (n) {
      ...
      return En({ step: r, alt: e, oct: t.oct, dir: t.dir });
    },
    ...
    Hn = function (n, t, r) {
      ...
      return void 0 === t
        ? { step: e, alt: m, dir: r }
        : { step: e, alt: m, oct: t + 4 * m + Ln[e], dir: r };
    },
    Jn = function (n, t) {
      return (
        void 0 === t && (t = {}),
    ...
    Xn = function (n) {
      return Wn(n) ? Hn(-n[0], -n[1], -1) : Hn(n[0], n[1], 1);
    },
    Yn = Object.freeze({
      transpose: l,
      trFifths: c,

  ...
  return (
      ...
      return (
        ...
        (e.prototype.set = function (t, i, n) {
          ...
          t: for (o in t) {
            ...
            (u = r[o]),
              e.isUndef(u) ||
                ((e.Signal && u instanceof e.Signal) ||
                (e.Param && u instanceof e.Param)
                  ? u.value !== i &&
                    (e.isUndef(n) ? (u.value = i) : u.rampTo(i, n))
                  : u instanceof AudioParam
                  ? u.value !== i && (u.value = i)
                  : e.TimeBase && u instanceof e.TimeBase
                  ? (r[o] = i)
                  : u instanceof e
                  ? u.set(i)
                  : u !== i && (r[o] = i));
          ...
          for (
            ...
            (u = o[s]),
              e.isObject(t[s])
                ...
                : u instanceof e
                ? (r[s] = u.get())
                : !e.isFunction(u) && e.isDefined(u) && (r[s] = u);
          }
          return i;
        }),
        (e.prototype._collectDefaults = function (t) {
          var i,
            ...
            s = [];
          if (
            (e.isDefined(t.defaults) && (s = Object.keys(t.defaults)),
            e.isDefined(t._super))
          )
            for (i = this._collectDefaults(t._super), n = 0; n < i.length; n++)
        ...
        (e.defaults = function (t, i, n) {
          ...
          else for (s = 0; s < i.length; s++) o[i[s]] = t[s];
        ...
        Object.defineProperty(e, "context", {
          ...
          set: function (i) {
            (t = e.Context && i instanceof e.Context ? i : new e.Context(i)),
              e.Context.emit("init", t);
          },
        }),
      ...
      return (
          ...
          for (n = 0; n < r.length; n++)
            if (((e = r[n]), this._events.hasOwnProperty(e)))
              if (t.isUndef(i)) this._events[e] = [];
                ...
                for (s = this._events[e], o = 0; o < s.length; o++)
                  s[o] === i && s.splice(o, 1);
          return this;
        }),
        (t.Emitter.prototype.emit = function (t) {
          ...
          if (
            ...
            for (i = this._events[t].slice(0), n = 0, s = i.length; n < s; n++)
              i[n].apply(this, e);
          return this;
        }),
      ...
      return (
        ...
        (t.Timeline.prototype.add = function (e) {
          ...
          return (
            ...
            this.length > this.memory &&
              ((n = this.length - this.memory), this._timeline.splice(0, n)),
            this
          );
        }),
        ...
        (t.Timeline.prototype._search = function (e, i) {
          ...
          if (
            ...
            (o = s),
            s > 0 && this._timeline[s - 1][i] <= e)
          )
            return s - 1;
          for (; n < o; ) {
            if (
              ((r = Math.floor(n + (o - n) / 2)),
              (a = this._timeline[r]),
        ...
        !window.hasOwnProperty("AudioContext") &&
          ...
          AudioContext.prototype.close ||
            (AudioContext.prototype.close = function () {
              return (
                t.isFunction(this.suspend) && this.suspend(), Promise.resolve()
              );
            }),
    ...
    t(function (t) {
      (t.Context = function () {
        ...
        if (
          ...
          !i.context && ((i.context = new window.AudioContext()), !i.context))
        )
          throw new Error(
        ...
        (t.Context.prototype.getConstant = function (t) {
          ...
          for (
            e = this._context.createBuffer(1, 128, this._context.sampleRate),
            ...
            i[n] = t;
          return (
            (s = this._context.createBufferSource()),
            (s.channelCount = 1),
          ...
          function e(e, i, s) {
            if (e.input)
              return (
                (s = t.defaultArg(s, 0)),
                t.isArray(e.input)
                  ? this.connect(e.input[s])
                  : this.connect(e.input, i, s)
              );
            try {
              return e instanceof AudioNode
                ? (n.call(this, e, i, s), e)
                : (n.call(this, e, i), e);
            } catch (t) {
        ...
        (t.AudioNode.prototype.disconnect = function (e, i, n) {
          t.isArray(this.output)
            ? t.isNumber(e)
              ...
              : ((i = t.defaultArg(i, 0)), this.output[i].disconnect(e, 0, n))
    ...
    t(function (t) {
      return (
        ...
        (t.TimeBase.prototype.valueOf = function () {
          ...
          return t.isDefined(this._units)
      ...
      return (
        ...
        (t.Time.prototype.toBarsBeatsSixteenths = function () {
          ...
          return (
            ...
            (s = s.toString()),
            s.length > 3 && (s = parseFloat(parseFloat(s).toFixed(3))),
            (t = [n, i, s]),
            t.join(":")
          );
        }),
      ...
      return (
        (t.Param = function () {
          ...
          t.AudioNode.call(this),
            ...
            t.isDefined(e.value) && this._param && (this.value = e.value);
        }),
        ...
        (t.Param.prototype.getValueAtTime = function (e) {
          ...
          return (
            ...
            (s = t.defaultArg(this._initialValue, this._param.defaultValue)),
            (o = s),
            null === n
              ? (o = s)
              : n.type === t.Param.AutomationType.Target
      ...
      if (t.supported && !AudioContext.prototype.createConstantSource) {
        var e = function (t) {
          ...
          (this._bufferSource = t.createBufferSource()),
            ...
            (s = this._output = t.createGain()),
            (this.offset = s.gain),
            this._bufferSource.connect(s);
        };
    ...
    t(function (t) {
      return (
        ...
        (t.Signal.prototype._isParam = function (e) {
          return (
            (t.Param && t.Param === e.constructor) || e instanceof AudioParam
          );
        }),
        ...
        (t.Signal.prototype._applyAutomations = function (t) {
          ...
          t.cancelScheduledValues(i),
            (e = this.getValueAtTime(i)),
            t.setValueAtTime(e, i),
            this._events.forEachFrom(i, function (e) {
      ...
      return (
            ...
            "linear" === this._attackCurve
              ...
              : s > 0 &&
                ...
                s < n &&
                  ...
                  (l = this._attackCurve.slice(c)),
                  (l[0] = r)),
                this._sig.setValueCurveAtTime(l, e, s, i)),
        ...
        (function () {
          ...
          for (s = [], o = 6.4, i = 0; i < d - 1; i++)
            (n = i / (d - 1)),
              (r = Math.sin(n * (2 * Math.PI) * o - Math.PI / 2) + 1),
              (s[i] = r / 10 + 0.83 * n);
          for (s[d - 1] = 1, a = [], h = 5, i = 0; i < d; i++)
            a[i] = Math.ceil((i / (d - 1)) * h) / h;
          for (l = [], i = 0; i < d; i++)
            (n = i / (d - 1)), (l[i] = 0.5 * (1 - Math.cos(Math.PI * n)));
          for (u = [], i = 0; i < d; i++)
            (n = i / (d - 1)),
              (c = 4 * Math.pow(n, 3) + 0.2),
              (p = Math.cos(c * Math.PI * 2 * n)),
              (u[i] = Math.abs(p * (1 - n)));
          t.Envelope.Type = {
            linear: "linear",
      ...
      return (
        ...
        Object.defineProperty(t.Filter.prototype, "rolloff", {
          ...
          set: function (e) {
            ...
            for (
              n += 1, this._rolloff = e, this.input.disconnect(), s = 0;
      ...
      return (
        ...
        (t.TickSignal.prototype.exponentialRampToValueAtTime = function (t, e) {
          ...
          for (
            e = this.toSeconds(e),
              ...
              n = Math.round(Math.max(10 * (e - i.time), 1)),
              s = (e - i.time) / n,
              o = 0;
            o <= n;
            o++
        ...
        (t.TickSignal.prototype._getTicksUntilEvent = function (e, i) {
          ...
          return (
            null === e
              ? (e = { ticks: 0, time: 0 })
              : t.isUndef(e.ticks) &&
                ((n = this._events.previousEvent(e)),
                (e.ticks = this._getTicksUntilEvent(n, e.time))),
            (s = this.getValueAtTime(e.time)),
            (o = this.getValueAtTime(i)),
            this._events.get(i).time === i &&
              this._events.get(i).type === t.Param.AutomationType.SetValue &&
        ...
        (t.TickSignal.prototype.getTimeOfTick = function (e) {
          ...
          return h && h.ticks === e
            ...
            : h &&
              l &&
              l.type === t.Param.AutomationType.Linear &&
              h.value !== l.value
            ? ((i = this.getValueAtTime(h.time)),
              (n = this.getValueAtTime(l.time)),
              (s = (n - i) / (l.time - h.time)),
              (o = Math.sqrt(Math.pow(i, 2) - 2 * s * (h.ticks - e))),
              (r = (-i + o) / s),
              (a = (-i - o) / s),
              (r > 0 ? r : a) + h.time)
            : h
            ? 0 === h.value
              ? 1 / 0
              : h.time + (e - h.ticks) / h.value
            : e / this._initialValue;
        }),
        (t.TickSignal.prototype.ticksToTime = function (e, i) {
          return (
            (i = this.toSeconds(i)), new t.Time(this.getDurationOfTicks(e, i))
          );
        }),
      ...
      return (
        ...
        (t.TickSource.prototype.stop = function (e) {
          if (
            ...
            i.time > 0 &&
              (this._tickOffset.cancel(i.time), this._state.cancel(i.time));
          }
          return (
        ...
        (t.TickSource.prototype.getTicksAtTime = function (e) {
          ...
          return (
            (e = this.toSeconds(e)),
            (i = this._state.getLastState(t.State.Stopped, e)),
        ...
        (t.TickSource.prototype.forEachTickBetween = function (e, i, n) {
          ...
          if (
            ...
            (e = Math.max(u.time, e)),
            u.state === t.State.Started && this._state)
          )
            for (
              s = this.frequency.getTicksAtTime(e),
                o = this.frequency.getTicksAtTime(u.time),
                r = s - o,
                a = r % 1,
                0 !== a && (a = 1 - a),
                h = this.frequency.getTimeOfTick(s + a),
                l = null;
              h < i && this._state;
    ...
    t(function (t) {
      (t.IntervalTimeline = function () {
        ...
        (t.IntervalTimeline.prototype.forEachAtTime = function (t, e) {
          var i, n, s;
          if (null !== this._root)
            for (i = [], this._root.search(t, i), n = i.length - 1; n >= 0; n--)
              (s = i[n].event) && e(s);
          return this;
        }),
      ...
      return (
        ...
        (t.TransportRepeatEvent.prototype._restart = function (e) {
          ...
          i > this.time &&
            (this._nextTick =
              this.time +
              Math.ceil((i - this.time) / this._interval) * this._interval),
      ...
      (t.Transport = function () {
        ...
        (t.Transport.prototype._processTick = function (e, i) {
          ...
          this._swingAmount > 0 &&
            ...
            ((n = (i % (2 * this._swingTicks)) / (2 * this._swingTicks)),
        ...
        (t.Transport.prototype.syncSignal = function (e, i) {
          ...
          return (
            ...
            this._syncedSignals.push({ ratio: s, signal: e, initial: e.value }),
            (e.value = 0),
            this
          );
        }),
    ...
    t(function (t) {
      return (
        (t.Buffer = function () {
          ...
          t.call(this),
            ...
            e.url instanceof AudioBuffer || e.url instanceof t.Buffer
              ? (this.set(e.url),
                e.onload &&
                  (this.loaded ? e.onload(this) : (this._onload = e.onload)))
              : t.isString(e.url) &&
        ...
        (t.Buffer.prototype.slice = function (e, i) {
          ...
          for (
            i = t.defaultArg(i, this.duration),
              ...
              s = Math.floor(this.context.sampleRate * this.toSeconds(i)),
              o = [],
              r = 0;
        ...
        (t.Buffer.load = function (e, i, n) {
          function s(e) {
            if (
              (t.Buffer._removeFromDownloadQueue(u),
          ...
          return (
            ...
            u.open("GET", t.Buffer.baseUrl + e, !0),
            (u.responseType = "arraybuffer"),
            (u.progress = 0),
            t.Buffer._downloadQueue.push(u),
            ...
            u.addEventListener("progress", function (t) {
              t.lengthComputable &&
                ((u.progress = (t.loaded / t.total) * 0.95), o());
            }),
            u.send(),
            u
          );
      ...
      return (
        (t.OscillatorNode = function () {
          ...
          t.AudioNode.call(this, e),
            ...
            (this.detune = new t.Param(this._oscillator.detune, t.Type.Cents)),
      ...
      return (
        ...
        Object.defineProperty(t.Oscillator.prototype, "type", {
          ...
          set: function (e) {
            ...
            0 === this._phase && s
              ...
              : ((i = this._getRealImaginary(e, this._phase)),
        ...
        (t.Oscillator.prototype._getRealImaginary = function (e, i) {
          ...
          for (
            ...
            0 !== r
              ? ((l[s] = -r * Math.sin(i * s)), (u[s] = r * Math.cos(i * s)))
              : ((l[s] = 0), (u[s] = 0));
          }
          return [l, u];
        }),
      ...
      if (t.supported && !window.StereoPannerNode) {
        var e = function (e) {
          ...
          (this.context = e),
            ...
            (a = new t.Zero()),
            a.fan(i, n),
            (h = this.output = new t.Merge()),
            r.left.chain(s, h.left),
            r.right.chain(o, h.right),
      ...
      return (
        ...
        (t.CtrlMarkov.prototype._getProbDistribution = function (e) {
          ...
          for (i = 0; i < e.length; i++)
            (n = e[i]),
              t.isObject(n)
                ? ((a = !0), (o[i] = n.probability))
                : (o[i] = 1 / e.length),
              (r += o[i]);
          if (a) for (s = 0; s < o.length; s++) o[s] = o[s] / r;
          return o;
        }),
    ...
    t(function (t) {
      return (
        (t.Buffers = function (e) {
          ...
          s.shift(),
            (i = t.defaults(s, ["onload", "baseUrl"], t.Buffers)),
            t.call(this),
            (this._buffers = {}),
    ...
    t(function (t) {
      function e(i, n, s, o) {
        ...
        return (
          (o = t.defaultArg(o, 0)),
          (r = new t.OfflineContext(2, n, s)),
          (t.context = r),
          (a = i(t.Transport)),
          r.currentTime > 0 && o < 1e3
            ? e(i, n, s, ++o)
            : { response: a, context: r }
        );
      }
      return (
        (t.Offline = function (i, n) {
          var s,
        ...
        (t.Freeverb = function () {
          ...
          for (
            t.StereoEffect.call(this, l),
              ...
              this.dampening = new t.Signal(l.dampening, t.Type.Frequency),
              this._combFilters = [],
          ...
          for (a = 0; a < e.length; a++)
            (h = new t.LowpassCombFilter(e[a])),
              a < e.length / 2
                ? this.effectSendL.chain(h, this._allpassFiltersL[0])
                : this.effectSendR.chain(h, this._allpassFiltersR[0]),
              this.roomSize.connect(h.resonance),
              this.dampening.connect(h.dampening),
              this._combFilters.push(h);
      ...
      return (
        ...
        (t.BufferSource.prototype.start = function (e, i, n, s, o) {
          ...
          return (
            ...
            (this._startTime = e),
            (r = this.toSeconds(
              t.defaultArg(n, this.buffer.duration - (i % this.buffer.duration))
            )),
            (r = Math.max(r, 0)),
            t.isDefined(n) &&
              (this.loop ||
        ...
        (t.BufferSource.prototype.cancelStop = function () {
          if (-1 !== this._startTime && !this._sourceStopped) {
            ...
            this._gainNode.gain.cancelScheduledValues(
              ...
              this._gainNode.gain.setValueAtTime(
                1,
                Math.max(this.now(), this._startTime + t + this.sampleTime)
              ),
          ...
          pink: (function () {
            ...
            for (t = 0; t < n; t++)
              for (
                ...
                (p = 2 * Math.random() - 1),
                  (s = 0.99886 * s + 0.0555179 * p),
                  (o = 0.99332 * o + 0.0750759 * p),
                  (r = 0.969 * r + 0.153852 * p),
                  (a = 0.8665 * a + 0.3104856 * p),
                  (h = 0.55 * h + 0.5329522 * p),
                  (l = -0.7616 * l - 0.016898 * p),
                  (e[c] = s + o + r + a + h + l + u + 0.5362 * p),
                  (e[c] *= 0.11),
                  (u = 0.115926 * p);
            return d;
          })(),
          ...
          return t
            .Offline(
              function () {
                ...
                i.connect(s.left),
                  n.connect(s.right),
                  (e = new t.Gain().toMaster()),
                  s.connect(e),
                  i.start(0),
                  n.start(0),
                  e.gain.setValueAtTime(0, 0),
                  e.gain.linearRampToValueAtTime(1, this.preDelay),
      ...
      return (
                ...
                e.state === t.State.Started &&
                  ...
                  this._loop
                    ? ((i = 1 / 0),
                      ...
                      (s = this._state.getAfter(n)),
                      null !== s && (i = Math.min(i, s.time - n)),
                      i !== 1 / 0 &&
                        (this._state.setStateAtTime(t.State.Stopped, n + i + 1),
                        (i = t.Ticks(i))),
                      (o = t.Ticks(this._getLoopDuration())),
        ...
        (t.Event.prototype.start = function (e) {
          return (
            (e = this.toTicks(e)),
            this._state.getValueAtTime(e) === t.State.Stopped &&
              (this._state.add({ state: t.State.Started, time: e, id: void 0 }),
    ...
    t(function (t) {
      return (
        ...
        (t.Part.prototype.at = function (e, i) {
          var n, s, o;
          for (
            e = t.TransportTime(e), n = t.Ticks(1).toSeconds(), s = 0;
            s < this._events.length;
            s++
          )
            if (
              ((o = this._events[s]), Math.abs(e.toTicks() - o.startOffset) < n)
            )
        ...
        (t.MetalSynth = function (i) {
          ...
          for (
            ...
            (s = new t.FMOscillator({
              ...
              (this._oscillators[n] = s),
              (o = new t.Multiply(e[n])),
        ...
        (t.PolySynth = function () {
          ...
          for (
            t.Instrument.call(this, n),
              ...
              n.polyphony = Math.min(t.PolySynth.MAX_POLYPHONY, n.polyphony),
        ...
        (t.Sampler.prototype.triggerRelease = function (e, i) {
          ...
          return (
            this._activeSources[s] &&
              this._activeSources[s].length &&
              ((n = this._activeSources[s].shift().source),
              (i = this.toSeconds(i)),
        ...
        (t.Sampler.prototype.add = function (e, i, n) {
          if (t.isNote(e)) {
            ...
            if (isNaN(parseFloat(e)))
              throw new Error(
                "Tone.Sampler: note must be the note's pitch. Instead got " + e
              );
      ...
      return (
        ...
        (t.TransportTimelineSignal.prototype.setValueCurveAtTime = function (
          ...
          return (
            (i = t.TransportTime(i)),
            (n = t.TransportTime(n)),
            t.Signal.prototype.setValueCurveAtTime.call(this, e, i, n, s),
            this
          );
        }),
      ...
      return (
        ...
        (t.Player.prototype._start = function (e, i, n) {
          ...
          return (
            (i = this._loop
              ...
              : t.defaultArg(i, 0)),
            (i = this.toSeconds(i)),
            (s = t.defaultArg(n, Math.max(this._buffer.duration - i, 0))),
            (s = this.toSeconds(s)),
            (e = this.toSeconds(e)),
            ...
            this._loop && t.isUndef(n) ? o.start(e, i) : o.start(e, i, s),
            this
          );
        }),
          ...
          set: function (e) {
            ...
            this._loop !== e &&
              ...
              e
                ...
                : this._stopAtNextIteration(i));
          },
        }),
        (t.Player.prototype._stopAtNextIteration = function (e) {
          var i, n, s, o;
          this._state.getValueAtTime(e) === t.State.Started &&
            ((i = this._state.getNextState(t.State.Stopped, e)),
        ...
        Object.defineProperty(t.Player.prototype, "position", {
          get: function () {
            var e,
              i = this.now();
            return this._state.getValueAtTime(i) === t.State.Started &&
              this.loaded
              ? ((e = this.buffer.duration),
                this._elapsedTime.getTicksAtTime(i) % e)
              : 0;
          },
        }),
      ...
      return (
        (t.Players = function (e) {
          var i,
            ...
            s = Array.prototype.slice.call(arguments);
          s.shift(),
            (i = t.defaults(s, ["onload"], t.Players)),
            t.call(this),
